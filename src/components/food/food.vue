      ...
      <div class="food-content">
        ...
        <div class="content">
          ...
          <div class="cartcontrol-wrapper">
            <cartcontrol class="cartcontrol" :food="food" @increase="addFood"></cartcontrol>
          </div>
          <transition name="in-cart">
        ...
        <div class="rating">
          ...
          <ratingselect :select-type="selectType" :only-content="onlyContent"
            :desc="desc" :ratings="food.ratings" @ratingstypeslect="selectRatingType" @togglecontent="toggleContent"></ratingselect>
